...
export function isNewerVersion(candidate: string, current = CLIENT_VERSION): boolean {
...
export function defaultUpdateDir(): string {
...
export async function openUpdatePackage(packagePath: string): Promise<void> {
