...
import com.studyshot.relay.update.AndroidUpdateManager
...
class StudyShotApp : Application() {
    ...
    val updateManager: AndroidUpdateManager by lazy {
        AndroidUpdateManager(this, apiClient, secureSettings)
    }
}
